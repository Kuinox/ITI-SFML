...
namespace SFML.Graphics
{
    ...
    public class RenderWindow : Window.Window, IRenderTarget
    {
        ...
        /// <summary>
        /// Creates the window with default style and creation settings.
        /// </summary>
        ...
        /// <summary>
        /// Creates the window with default creation settings.
        /// </summary>
        /// <param name="mode">Video mode to use.</param>
        /// <param name="title">Title of the window.</param>
        ...
        /// <summary>
        /// Creates the window from an existing control with default creation settings.
        /// </summary>
        ...
        /// <summary>
        /// Creates the window from an existing control.
        /// </summary>
        /// <param name="handle">Platform-specific handle of the control.</param>
        /// <param name="settings">Creation parameters.</param>
        ...
        /// <summary>
        /// Gets whether the window is opened (ie. has been created).
        /// Note that a hidden window (Show(false)) will still return true.
        /// </summary>
        ...
        /// <summary>
        /// Gets the creation settings of the window.
        /// </summary>
        ...
        /// <summary>
        /// Changes the joystick threshold, ie. the value below which
        ...
        /// <summary>
        /// Activates of deactivates the window as the current target.
        /// for rendering.
        /// </summary>
        ...
        [DllImport( CSFML.Graphics, CallingConvention = CallingConvention.Cdecl ), SuppressUnmanagedCodeSecurity]
        static extern Vector2 sfRenderWindow_mapPixelToCoords( IntPtr CPointer, Vector2i point, IntPtr View );

        [DllImport( CSFML.Graphics, CallingConvention = CallingConvention.Cdecl ), SuppressUnmanagedCodeSecurity]
        static extern Vector2i sfRenderWindow_mapCoordsToPixel( IntPtr CPointer, Vector2 point, IntPtr View );
